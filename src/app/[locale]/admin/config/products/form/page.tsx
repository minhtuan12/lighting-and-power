...
const ProductForm = () => {
    ...
    useEffect(() => {
        if (isEdit && productData?.data) {
            ...
            if (product.relatedProducts) setSelectedRelatedProducts(product.relatedProducts.map((i: IProduct) => i._id) as string[]);
        }
                        ...
                        <Col span={8}>
                            ...
                            >
                                <FloatingSelect
                                    ...
                                    options={convertNestedCategories(categoriesList.filter((i: ICategory) => i.childrenCount === 0))}
                                />
                            </Form.Item>
                            <Form.Item
                                name="manufacturer"
